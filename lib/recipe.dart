class Recipe {
  ...
  final String editorialStatus,chef,cookingMethod,cookingDetail;
  ...
  const Recipe({required this.id,required this.title,required this.country,required this.cuisine,
    ...
    required this.ingredients,required this.steps,required this.tags,required this.editorialStatus, this.chef='', this.cookingMethod='', this.cookingDetail='', this.cookingTempC});
  factory Recipe.fromJson(Map<String,dynamic> j)=>Recipe(
    ...
    editorialStatus:j['editorialStatus']??'draft',chef:j['chef']??'',cookingMethod:j['cookingMethod']??'',cookingDetail:j['cookingDetail']??'',cookingTempC:j['cookingTempC'] is int ? j['cookingTempC'] as int : null);
}
