class Recipe {
  ...
  const Recipe({required this.id,required this.title,required this.country,required this.cuisine,
    ...
    required this.ingredients,required this.steps,required this.tags,required this.editorialStatus, this.variants=const [], this.chef='', this.cookingMethod='', this.cookingDetail='', this.cookingTempC, this.continent='', this.macroArea='', this.imageUrl=''});
  factory Recipe.fromJson(Map<String,dynamic> j)=>Recipe(
    ...
    editorialStatus:j['editorialStatus']??'draft',chef:j['chef']??'',cookingMethod:j['cookingMethod']??'',cookingDetail:j['cookingDetail']??'',cookingTempC:j['cookingTempC'] is int ? j['cookingTempC'] as int : null,continent:j['continent']??'',macroArea:j['macroArea']??'',imageUrl:j['imageUrl']??'');
}
