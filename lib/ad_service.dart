...
class AdService {
  ...
  Future<void> showInterstitialIfReady() async {
    // Inizializza consenso e SDK pubblicitario solo quando serve davvero:
    // non devono competere con il rendering dell'app durante l'avvio.
    final canRequestAds = await AdConsentService.instance.initialize().timeout(
