...
class RecipePage extends StatefulWidget{final Recipe recipe;final bool selected;final VoidCallback onFavorite;final ValueChanged<String> onAdd;final VoidCallback onAddAll;final double rating,taste;final int ratingCount,tasteCount;final ValueChanged<int> onRate,onTaste;const RecipePage({super.key,required this.recipe,required this.selected,required this.onFavorite,required this.onAdd,required this.onAddAll,required this.rating,required this.taste,required this.ratingCount,required this.tasteCount,required this.onRate,required this.onTaste});@override State<RecipePage> createState()=>_RecipePageState();}
