...
class _AppShellState extends State<AppShell>{
 ...
 void _buildCatalogCaches(List<Recipe> recipes){
  ...
  _italianCount=0;
  final hamburger=[...specialHamburgerRecipes];
  ...
  for(final r in _catalog){
    ...
    if(title.contains('hamburger')||tags.any((x)=>x.contains('burger')))hamburger.add(r);
  ...
  _specialHamburger=List<Recipe>.unmodifiable(hamburger);
