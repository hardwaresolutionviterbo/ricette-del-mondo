...
class _AppShellState extends State<AppShell>{
    ...
    child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
      ...
      Card(
        ...
        child:InkWell(onTap:()=>openRecipe(recipe),child:Stack(children:[
          ...
          Positioned.fill(child:DecoratedBox(decoration:BoxDecoration(gradient:LinearGradient(begin:Alignment.topCenter,end:Alignment.bottomCenter,colors:[Colors.transparent,Colors.transparent,Colors.black.withOpacity(.72)])))),
          Positioned(left:15,top:14,child:Container(padding:const EdgeInsets.symmetric(horizontal:12,vertical:7),decoration:BoxDecoration(color:green,borderRadius:BorderRadius.circular(18),boxShadow:[BoxShadow(color:Colors.black.withOpacity(.18),blurRadius:10)]),child:const Text('RICETTA DEL GIORNO',style:TextStyle(color:Colors.white,fontSize:10,fontWeight:FontWeight.w900,letterSpacing:.8)))),
 ...
 Widget homeHero(int total,int italian,int world)=>TweenAnimationBuilder<double>(
  ...
  child:Container(
    decoration:BoxDecoration(
      ...
      boxShadow:[BoxShadow(color:green.withOpacity(.18),blurRadius:28,offset:const Offset(0,12))],
    ),
    child:ClipRRect(
      borderRadius:BorderRadius.circular(30),
      child:Stack(
        children:[
          ...
          Positioned(right:-70,top:-80,child:Container(width:250,height:250,decoration:BoxDecoration(shape:BoxShape.circle,color:Colors.white.withOpacity(.055)))),
          Positioned(left:-90,bottom:-115,child:Container(width:300,height:300,decoration:BoxDecoration(shape:BoxShape.circle,color:orange.withOpacity(.10)))),
          Padding(
            ...
            child:Column(children:[
              Row(children:[
                Container(
                  ...
                  decoration:BoxDecoration(color:Colors.white.withOpacity(.10),borderRadius:BorderRadius.circular(20),border:Border.all(color:Colors.white.withOpacity(.13))),
              ...
              Text('Scopri sapori, tradizioni e cucine da tutto il mondo.',textAlign:TextAlign.center,style:TextStyle(color:Colors.white.withOpacity(.82),fontSize:12.5,fontWeight:FontWeight.w500)),
              const SizedBox(height:17),
              Container(
                padding:const EdgeInsets.symmetric(horizontal:8,vertical:13),
                decoration:BoxDecoration(color:Colors.white.withOpacity(.105),borderRadius:BorderRadius.circular(22),border:Border.all(color:Colors.white.withOpacity(.15))),
                child:Row(children:[
 ...
 Widget homeStat(String value,String label,IconData icon)=>Expanded(child:Column(children:[Icon(icon,color:Colors.white.withOpacity(.82),size:19),const SizedBox(height:4),Text(value,style:const TextStyle(color:Colors.white,fontSize:20,fontWeight:FontWeight.w900)),Text(label,style:TextStyle(color:Colors.white.withOpacity(.70),fontSize:8.5,fontWeight:FontWeight.w800,letterSpacing:.7))]));
 Widget homeDivider()=>Container(width:1,height:48,color:Colors.white.withOpacity(.16));
...
class _PremiumPageState extends State<PremiumPage>{
 ...
 const SizedBox(height:18),const Text('Scegli il tuo abbonamento',style:TextStyle(fontSize:22,fontWeight:FontWeight.w900,color:ink)),const SizedBox(height:6),const Text('Puoi scegliere il rinnovo automatico oppure un acquisto una tantum.',style:TextStyle(fontSize:13,color:Colors.black54)),const SizedBox(height:8),
